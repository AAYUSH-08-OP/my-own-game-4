...
function draw() {
  ...
  if(keyDown("up_arrow")&& soldier.y >= 0) {
    soldier.velocityY= -2;
  }

  if(keyDown("down_arrow")&& soldier.y >= 0) {
    soldier.velocityY= 2;
  }

  if(applegroup.isTouching(soldier)){
    score = score + 10;
  }

  if(snakegroup.isTouching(soldier) &&  score > 10){
    score = score - 10;
  }

  if(stonegroup.isTouching(soldier) && score > 5){
    score = score - 5;
  }
